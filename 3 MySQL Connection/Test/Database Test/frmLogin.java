 ...
 */
 ...
 private void getEmpCode()
 {
  if(F1.exists())
  {
   ...
   {JOptionPane.showMessageDialog(null,"*** frmLogin.getEmpCode Error"+"\nError: "+e,"Error",JOptionPane.ERROR_MESSAGE);}
  }
  else
  {
   System.out.println("*** frmLogin.getEmpCode Error: Log File not Found!");
  }
 }
 ...
 */
 ...
 private void writeEmpCode()
 {
  ...
  {System.out.println("*** frmLogin.writeEmpCode Error"+"\nError: "+e);}
 }
 ...
 */
 ...
 private void getTB()
 {
  if(F2.exists())
  {
   ...
   {JOptionPane.showMessageDialog(null,"*** frmLogin.getTB Error"+"\nError: "+e,"Error",JOptionPane.ERROR_MESSAGE);}
  }
  else
  {System.out.println("*** frmLogin.getTB Error: Log File not Found!");}
 }
 ...
 */
 ...
 private void checkUser()
 {
  ...
  {
   getTB();
   frmMain mn = new frmMain("MASTER", TB, pass);
   dispose();
   mn.setVisible(true);
   return;
  }
  else
  {
   ...
   try
   {
    if (usercon.isFound(srchStr))
    {
     if (InsertRecord()==true)
     {
      ...
      getTB();
      dispose();
      frmMain mn = new frmMain(EmpCode, TB, pass);
      mn.setVisible(true);
     }
    }
    else
    {
     ...
     System.out.println("frmLogin.checkUser: Invalid User OR Password...\n");
     txtEmpCode.requestFocus();
     txtEmpCode.selectAll();
     txtPass.setCaretColor(Color.blue);
     txtPass.setText("");
   ...
   {System.out.println("Client [frmLogin]: CHECK USER Error");System.out.println("Error: "+re.getMessage());}
  }
 }
 ...
 */
 ...
 public boolean InsertRecord()
 {
  ...
  {
   System.out.println("Client [frmLogin]: INSERT RECORD Error");System.out.println("Error: "+re.getMessage());
   JOptionPane.showMessageDialog(null, "INSERT RECORD Error\nClient [frmLogin]: "+re.getMessage(),
            "Error", JOptionPane.ERROR_MESSAGE);
   return savesucc;
  }
